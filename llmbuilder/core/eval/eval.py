...
from llmbuilder.core.training.dataset import TextDataset, MultiFileDataset, create_dataloader
from llmbuilder.core.training.utils import synchronize_vocab_size
    ...
    def generate_text(self, prompt: str,
        ...
        for _ in range(num_samples):
            try:
                ...
                # Generate
                with torch.no_grad():
                    # Check what parameters the generate method supports
                    import inspect
                    ...
                    generated = self.model.generate(prompt_tensor, **generate_kwargs)
